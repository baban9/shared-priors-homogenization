...
Topic-level permutation tests reject the null for both InstructGPT contrasts ($p=0.003$ and $p=0.001$), while the solo-versus-GPT-3 contrast does not ($p=0.71$).
...
The GPT-3 minus InstructGPT gap is $0.047$ (95\% CI $[0.001, 0.097]$; permutation $p=0.001$).
The solo minus InstructGPT gap is $0.040$ (CI $[-0.018, 0.099]$; $p=0.003$); $90.7\%$ of bootstrap replicates are positive.
The solo minus GPT-3 gap is near zero ($p=0.71$).
...
\midrule
solo $-$ IGPT & \phantom{-}0.040 & $-0.018$ & 0.099 & 0.003 \\
GPT-3 $-$ IGPT & \phantom{-}0.047 & \phantom{-}0.001 & 0.097 & 0.001 \\
solo $-$ GPT-3 & $-0.008$ & $-0.063$ & 0.046 & 0.709 \\
\bottomrule
\end{tabular}}

Under InstructGPT, model spans are less diverse than user spans (Table~\ref{tab:auth}: TF--IDF $0.820$ vs $0.832$; embeddings $0.316$ vs $0.364$).
...
instructgpt user & 96 & 0.832 & 0.364 \\
